      ...
      >
        {verify.isSuccess ? (
          <>
            ...
            <h1 className="text-heading font-bold mb-2">{t("recover.verifiedTitle")}</h1>
          ...
          <>
            ...
            <h1 className="text-heading font-bold mb-2">{t("recover.verifyFailedTitle")}</h1>
            <p className="text-body text-muted-foreground mb-6">
              {token ? t("recover.verifyFailedSub") : t("recover.missingToken")}
            </p>
            <Link href="/dashboard" className="text-body text-[#c084fc] hover:underline">
          ...
          <>
            ...
            <h1 className="text-heading font-bold">{t("recover.verifyingTitle")}</h1>
          </>
        )}
      </motion.div>
    </div>
