      ...
      >
        {!token ? (
          <div className="text-center">
            ...
            <h1 className="text-heading font-semibold mb-2">{t("recover.badLink")}</h1>
          ...
          <div className="text-center">
            ...
            <h1 className="text-heading font-semibold mb-2">{t("recover.resetDone")}</h1>
            <p className="text-body text-muted-foreground mb-6">{t("recover.resetDoneSub")}</p>
            <Link
              href="/auth"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-primary text-primary-foreground text-body font-semibold hover:bg-[#a855f7] transition-colors"
            >
          ...
          <>
            <div className="text-center mb-8">
              <h1 className="text-heading font-semibold mb-2">{t("recover.resetTitle")}</h1>
