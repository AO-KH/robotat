      ...
      >
        {!token ? (
          <div className="text-center">
            ...
            <h1 className="text-heading font-bold mb-2">{t("recover.badLink")}</h1>
            <Link href="/forgot-password" className="text-body text-[#c084fc] hover:underline">
          ...
          <div className="text-center">
            ...
            <h1 className="text-heading font-bold mb-2">{t("recover.resetDone")}</h1>
            <p className="text-body text-muted-foreground mb-6">{t("recover.resetDoneSub")}</p>
            <Link
              href="/auth"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-primary text-primary-foreground text-body font-medium hover:bg-[#a855f7] transition-colors"
            >
          ...
          <>
            <div className="text-center mb-8">
              <h1 className="text-heading font-bold mb-2">{t("recover.resetTitle")}</h1>
              <p className="text-body text-muted-foreground">{t("recover.resetSub")}</p>
            </div>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5" noValidate>
              <div className="space-y-2">
                <label className="text-label font-medium text-foreground/80">{t("recover.newPassword")}</label>
                ...
                {form.formState.errors.newPassword && (
                  <p className="text-label text-destructive">{form.formState.errors.newPassword.message}</p>
                )}
              </div>
              <button
                type="submit"
